...
function displayPics() {
  ...
  //By changing from var to let we've changed the scope in which rando is accessible. It is now only accessible within the block where it is declared, rather than being accessible within the whole function.
